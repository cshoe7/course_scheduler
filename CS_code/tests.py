...
class TestCourseMethods(unittest.TestCase):
    ...
    def test_get_prof(self):
        self.assertEqual(self.user.course.get_prog(), "Dr. T")
...
and what everything means, so it may not be all inclusive. I just wanted to make sure we included
some element of test for the actual llm itself.
"""
